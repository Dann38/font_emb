...
class TestSymbolsGetter(unittest.TestCase):

    def test_order(self):
        path_project = os.path.dirname(os.path.join(os.getcwd(), "."))
        ...
        exual_result = SymbolsExtractor.take_symbols_and_bboxes(path_img, "eng")
